...
from models.load_model import ESPEAK_DLL, ESPEAK_DIR, OBJECT_DIR
...
with open(os.path.join(OBJECT_DIR, "models/tts/maskgct/g2p/utils/mls_en.json"), "r", encoding='utf-8') as f:
    json_data = f.read()
